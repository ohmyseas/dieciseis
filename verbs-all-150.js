const VERBS = {
  ...
  'so': {
    present: ['sueño', 'sueñas', 'sueña', 'soñamos', 'soñáis', 'sueñan'],
    preterite: ['soñé', 'soñaste', 'soñó', 'soñamos', 'soñasteis', 'soñaron'],
    imperfect: ['soñaba', 'soñabas', 'soñaba', 'soñábamos', 'soñabais', 'soñaban'],
    future: ['soñaré', 'soñarás', 'soñará', 'soñaremos', 'soñaréis', 'soñarán'],
  },
  'almorzar': {
